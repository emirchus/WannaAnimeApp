...
class ApiRepositoryImpl extends ApiRepository {
  ...
  @override
  Future<List<MangaEntity>> getMangas({int start = 1, int end = 20, String search = ''}) async {
    MangasDTO dto = await Services.getMangas(start: start, end: end, search: search);
    log(dto.message);
    if (dto.statusCode == 200) {
      return dto.toMangas()!;
    } else {
  ...
  @override
  Future<List<MangaEntity>> getTrendingMangas() async {
    MangasDTO dto = await Services.getTrendingMangas();
